...
export const demoRepairJobs: RepairJob[] = [
  {
    ...
    revision: 3,
    status: 'assigned',
    customerLabel: '이용자 C-1042',
    device: { publicCode: 'MR-2208', model: '나래 모빌리티 M-22' },
    issue: '오른쪽 바퀴 소음 점검',
    scheduledAt: null,
    scheduleLabel: '일정 협의 필요',
    priority: 'today',
  ...
  },
  {
    ...
    revision: 4,
    status: 'scheduled',
    customerLabel: '이용자 C-1077',
    device: { publicCode: 'MR-2311', model: '케어라이드 S-4' },
    issue: '배터리 교체 상담',
    scheduledAt: '2026-08-14T01:30:00.000Z',
    scheduleLabel: '8월 14일(금) 오전 10:30',
    priority: 'scheduled',
    billedAmountKrw: null,
    submittedAt: null,
    workItems: [],
  ...
  },
  {
    ...
    revision: 5,
    status: 'in_progress',
    customerLabel: '이용자 C-1091',
    device: { publicCode: 'MR-2118', model: '나래 모빌리티 M-18' },
    issue: '정기 점검',
    scheduledAt: '2026-08-19T04:00:00.000Z',
    scheduleLabel: '8월 19일(수) 오후 1:00',
    priority: 'scheduled',
    billedAmountKrw: null,
    submittedAt: null,
    workItems: [],
