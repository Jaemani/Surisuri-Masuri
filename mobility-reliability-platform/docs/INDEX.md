...
- ADR-0018 R5의 provider-neutral classification request/result/inventory 계약, purpose별 opaque read grant와 strict manifest shape decoder는 WSL2 Docker의 local synthetic gate에서 구현·검증됐다. [EVD-20260721-019](./evidence/2026-07.md)은 `generated`이며 clean CI 전이다. 실제 GCS inventory·exact read, raw validator/codec, classification orchestration과 runtime 연결은 미구현이다.
