...
| 교수 미팅·노션에 어떤 제품 화면을 사용하는가 | [승인 브랜드 화면 세트](./evidence/EVD-20260820-002-corrected-brand-screenshot-set.md) | [브랜드 결정 ADR-0067](./decisions/ADR-0067-approved-product-brand-source.md), [Web·Playwright Runbook](./development/WEB_PLAYWRIGHT_RUNBOOK.md) |
