...
| 9월 | Device Timeline & Reliability | 수리 importer, verified completed-repair 기반 모바일·복지관 console read-time timeline, normalized event 기반 device current-state deterministic replay, 기기·부품 projection, 주행 품질 ML, 생존분석 baseline | 역할별 기기 타임라인·시점별 상태 재현과 위험곡선 | R09, R10 |
