...
| RSK-06 | 동의 철회·삭제 계보 실패 | critical/medium | withdrawn trip ingest, orphan object | consent revision authorizer, deletion manifest, reconciliation | staging 삭제 drill 실패 | active |
...
| RSK-10 | partial failure로 object/receipt 불일치 | high/medium | reserved age, orphan object, hash mismatch | Firestore transaction, generation precondition, sweeper, DLQ | recovery/replay test 실패 | active |
