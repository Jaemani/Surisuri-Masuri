...
| RSK-06 | 동의 철회·삭제 계보 실패 | critical/medium | withdrawn trip ingest, orphan object | consent revision authorizer와 atomic admission local 검증, deletion manifest, reconciliation | 실제 transaction 경쟁·staging 삭제 drill 실패 | active |
