...
- [ADR-0033](./decisions/ADR-0033-fenced-resumable-receipt-linkage-purge.md)의 R8k-a/b와 R8k-c 중 cleanup-target registry/backfill local control plane을 구현했다. R8k-a는 tenant+receipt digest job, strict job/fence codec, job+receipt create-once admission과 read-only response-loss correlation을 제공한다. R8k-b는 synthetic nested `recoveryAttempts`를 bounded page로 발견하고 transaction 안에서 page/lookahead와 exact raw document를 재검증한 뒤 delete와 cursor/count/revision을 함께 commit한다. R8k-c의 구현된 범위는 신규 cleanup target+inverse link atomic create, tenant-wide bounded legacy inventory, strict target·parent·link revalidation과 create-only backfill이다. R8k-a/b 근거는 [EVD-20260723-042](./evidence/2026-07.md#evd-20260723-042--bounded-nested-recovery-attempt-purge)와 [HR-20260723-33](./reports/human/HR-20260723-33-nested-recovery-attempt-purge.md), registry/backfill 근거는 [EVD-20260723-043](./evidence/2026-07.md#evd-20260723-043--cleanup-target-inverse-registry와-legacy-backfill)과 [HR-20260723-34](./reports/human/HR-20260723-34-legacy-purge-link-backfill.md)에 있다. Integrity finding schema/writer/backfill, linked target/finding delete, fresh empty/unregistered verification, final receipt·두 uniqueness index delete, Rules/indexes와 runtime이 남아 ADR은 계속 `proposed`다. `purge_eligible_at`, job admission, attempt phase 완료와 legacy page exhaustion은 전체 purge 완료나 global orphan-zero가 아니다.
